<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/wwwroot/company/public/../application/admin/view/aboutcompany/aboutc-edit.html";i:1558419926;s:62:"/www/wwwroot/company/application/admin/view/common/header.html";i:1558333979;}*/ ?>
﻿<!DOCTYPE html>
<html>
 ...
 <div class="layui-side layui-bg-black x-side" style="top:99px">
    <div class="layui-side-scroll">
        <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
            ...
            <li class="layui-nav-item" style="height: 30px; text-align: center">
             ...
             <div class="x-nav" style="margin-left: 220px;">
                <span class="layui-breadcrumb">
                  ...
                  <a href="<?php echo url('admin/aboutcompany/edit'); ?>">编辑公司信息</a>
                </span>
           ...
           <div class="x-body" style="margin-left: 220px;padding:0;" id="x-img">
           <form class="layui-form" style="margin-top: 20px;" action="" enctype="multipart/form-data" method="post">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 500px;">
                            ...
                            autocomplete="off" class="layui-input" placeholder="请输入公司名称" oninput="companyname1()" value="<?php echo $aboutitem['companyname']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 500px;">
                            ...
                            autocomplete="off" class="layui-input" placeholder="请输入创始成员" value="<?php echo $aboutitem['persons']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 500px;">
                          <input class="layui-input" placeholder="请选择创建时间" id="LAY_demorange_s" name="ctime" required="" lay-verify="required" autocomplete="off" value=" <?php echo substr($aboutitem['ctime'],0,10); ?>">
                        </div>
                      </div>
                     ...
                     <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 500px;">
                            ...
                            autocomplete="off" class="layui-input" placeholder="请输入座机号码" value="<?php echo $aboutitem['phone']; ?>">
                        </div>
                    </div>
                     <div class="layui-form-item">
                        <label for="link" class="layui-form-label">
                        ...
                        <div class="layui-input-inline" style="width: 500px;">
                            ...
                            autocomplete="off" class="layui-input" placeholder="请输入手机号码" value="<?php echo $aboutitem['telphone']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 500px;">
                            ...
                            autocomplete="off" class="layui-input" placeholder="请输入地址" value="<?php echo $aboutitem['address']; ?>">
                        </div>
                       </div>
                       ...
                       <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 500px;">
                            ...
                            autocomplete="off" class="layui-input" placeholder="请输入邮箱" value="<?php echo $aboutitem['email']; ?>">
                        </div>
                       </div>
                        ...
                        <div class="layui-input-inline" style="width: 500px;">
                          <input type="file" name="img[]" style="position: relative;top:10px;margin-bottom: 10px;"><img src="http://www.aisanhui.com/static<?php echo $aboutitem['officeimg']; ?>" height="20">
                          <input type="file" name="img[]" style="position: relative;top:10px;margin-bottom: 10px;"><img src="http://www.aisanhui.com/static<?php echo $aboutitem['officeimg2']; ?>" height="20">
                          <input type="file" name="img[]" style="position: relative;top:10px;margin-bottom: 10px;" ><img src="http://www.aisanhui.com/static<?php echo $aboutitem['officeimg3']; ?>" height="20">
                          <input type="file" name="img[]" style="position: relative;top:10px;margin-bottom: 10px;"><img src="http://www.aisanhui.com/static<?php echo $aboutitem['officeimg4']; ?>" height="20">
                          <input type="file" name="img[]" style="position: relative;top:10px;margin-bottom: 10px;"><img src="http://www.aisanhui.com/static<?php echo $aboutitem['officeimg5']; ?>" height="20">
                        </div>
                    </div>
                      ...
                      <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 500px;">
                            ...
                            autocomplete="off" class="layui-input" style="height: 100px;line-height: 20px;" placeholder="请输入公司简介"><?php echo $aboutitem['jianjie']; ?></textarea>
                        </div>
                    </div>
