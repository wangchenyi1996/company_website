<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/www/wwwroot/company/public/../application/index/view/custormcase/casedetail.html";i:1558424633;s:62:"/www/wwwroot/company/application/index/view/common/header.html";i:1558401077;s:62:"/www/wwwroot/company/application/index/view/common/footer.html";i:1558423112;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head lang="en">
  <meta charset="UTF-8">
...
<div class="toppic">
	 ...
	 <div class="toppic-title left">
      ...
      <div style="margin-top:8px;margin-bottom: 5px;">
        <!-- <i class="am-icon-paper-plane toppic-title-i"></i> -->
        <img src="http://www.aisanhui.com/static/index/img/example.png" class="toppic-title-i" style="position: relative;top:5px;" />
		...
		<div class="right toppic-progress">
			...
			<span><a href="<?php echo url('index/casedetail/index'); ?>" class="w-white">案例详情</a></span>
		</div>
	</div>
</div>
    	...
    	<div class="product-content">
		    	<div class="left am-u-sm-12 am-u-md-6 am-u-lg-6 product-content-left case-left">
		    		<div class="product-show-title">
		    			<h3><?php echo $detail['casename']; ?></h3>
		    		</div>
             ...
             <img class="case-img" src="http://www.aisanhui.com/static<?php echo $detail['caseimg']; ?>" style="background-color: #fff;" />
		    	</div>	
		    	<div class="clear"></div>
    	</div>
	</div>
