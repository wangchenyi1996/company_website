<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/company/public/../application/admin/view/adminer/admin-edit.html";i:1558325123;s:62:"/www/wwwroot/company/application/admin/view/common/header.html";i:1558333979;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
            ...
            <div class="x-nav" style="margin-left: 220px;">
                    <span class="layui-breadcrumb">
                      ...
                      <a href="<?php echo url('admin/adminer/edit'); ?>">编辑管理员</a>
                    </span>
                ...
                <form class="layui-form" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="username" name="username" required="" lay-verify="required" value="<?php echo $admins['username']; ?>" 
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            ...
                            autocomplete="off" class="layui-input" value="<?php echo $admins['password']; ?>">
                        </div>
                        <div class="layui-form-mid layui-word-aux">
                            6到16个字符
                        </div>
