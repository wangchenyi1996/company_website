<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/company/public/../application/admin/view/job/job-list.html";i:1558325125;s:62:"/www/wwwroot/company/application/admin/view/common/header.html";i:1558333979;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="layui-side-scroll">
        <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
            ...
            <div style="margin-left:220px;">
                ...
                <div class="x-body">
                    <xblock>
                        <button class="layui-btn" onclick="window.location.href='<?php echo url('admin/job/add'); ?>'"><i class="layui-icon">&#xe608;</i>添加</button>
                        ...
                        <tbody id="x-img">
                            ...
                            <tr>
                                ...
                                <td class="td-manage">
                                    ...
                                    <a title="编辑" href="<?php echo url('admin/job/edit',array('id'=>$vo['id'])); ?>" class="ml-5" style="text-decoration:none;margin-right: 20px;">
                                        <i class="layui-icon">&#xe642;</i>编辑
                                    </a>
                                    <a title="删除" onclick="admin_del('<?php echo url('admin/job/del',array('id'=>$vo['id'])); ?>')">
