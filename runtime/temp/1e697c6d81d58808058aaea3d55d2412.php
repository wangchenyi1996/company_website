<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"/www/wwwroot/company/public/../application/index/view/news/news.html";i:1558424775;s:62:"/www/wwwroot/company/application/index/view/common/header.html";i:1558401077;s:62:"/www/wwwroot/company/application/index/view/common/footer.html";i:1558423112;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head lang="en">
  <meta charset="UTF-8">
	 ...
	 <div class="am-container-1">
	 	<div class="toppic-title left">
			...
			<div style="margin-top:9px;margin-bottom: 5px;">
				<img src="http://www.aisanhui.com/static/index/img/newsinfo.png" class="toppic-title-i" style="height:28px;">
	...
	<div class="left am-u-sm-12 am-u-md-8 am-u-lg-9 ">
      ...
      <?php if(is_array($news) || $news instanceof \think\Collection || $news instanceof \think\Paginator): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['newsimg'] != ''): ?>
  	  	<li class="am-u-sm-12 am-u-md-6 am-u-lg-4" style="height: 401px">
              ...
              <img class="news-ul-liimg" src="http://www.aisanhui.com/static<?php echo $vo['newsimg']; ?>" style="height: 243px;width: 243px;border-radius: 4px;box-sizing: border-box;" />
