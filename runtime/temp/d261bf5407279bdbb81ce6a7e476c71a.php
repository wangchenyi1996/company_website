<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/company/public/../application/admin/view/cases/case-list.html";i:1558325124;s:62:"/www/wwwroot/company/application/admin/view/common/header.html";i:1558333979;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
三晖科技后台管理系统        </title>
 ...
 <div class="layui-side layui-bg-black x-side" style="top:99px">
    <div class="layui-side-scroll">
        ...
        <div class="x-body">
            <xblock><button class="layui-btn" onclick="window.location.href='<?php echo url('admin/cases/add'); ?>'"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：<?php echo $count; ?> 条</span></xblock>
            <table class="layui-table">
                ...
                <tbody id="x-img">
                    ...
                    <tr>
                        ...
                        <td >
                           <?php echo $vo['casetype']; ?>
                        </td>
                         <td>
                           <?php echo $vo['caseurl']; ?>
                        </td>
                        <td style="width: 50px">
                           <img src="http://www.aisanhui.com/static<?php echo $vo['caselogo']; ?>" width="42" height="42">
                        </td> 
                        <td style="width: 100px;">
                            <img src="http://www.aisanhui.com/static<?php echo $vo['caseimg']; ?>" height="50">
                        </td>
                        <td style="width: 80px;">
                        ...
                        <td style="width: 270px;">
                             <?php echo $vo['casecontent']; ?>
                        </td>
                        <td>
                           <?php echo $vo['custormname']; ?>
                        </td>
                         <td >
                        ...
                        <td class="td-manage">
                            <a title="编辑" href="<?php echo url('admin/cases/edit',array('id'=>$vo['id'])); ?>" class="ml-5" style="margin-right: 20px;">
                                <i class="layui-icon">&#xe642;</i>编辑
                            </a>
                            <a title="删除" onclick="admin_del('<?php echo url('admin/cases/del',array('id'=>$vo['id'])); ?>')">
