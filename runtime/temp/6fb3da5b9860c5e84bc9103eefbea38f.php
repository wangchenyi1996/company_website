<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/company/public/../application/admin/view/adminer/admin-list.html";i:1558325123;s:62:"/www/wwwroot/company/application/admin/view/common/header.html";i:1558333979;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
           ...
           <div style="margin-left: 210px;">
                ...
                <div class="x-body">
                    <xblock>
                    	...
                    	<button class="layui-btn" onclick="window.location.href='<?php echo url('admin/adminer/add'); ?>'"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：<?php echo $count; ?> 条</span></xblock>
                        ...
                        <tbody>
                            <?php if(is_array($adminlist) || $adminlist instanceof \think\Collection || $adminlist instanceof \think\Paginator): $i = 0; $__LIST__ = $adminlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td class="td-manage">
                                        <a title="编辑" href="<?php echo url('admin/adminer/edit',array('id'=>$vo['id'])); ?>"
                                        class="ml-5" style="text-decoration:none;margin-right: 20px;">
                                            <i class="layui-icon">&#xe642;</i>编辑
                                        </a>
                                       
                                        <a title="删除"  style="text-decoration:none" onclick="admin_del('<?php echo url('admin/adminer/del',array('id'=>$vo['id'])); ?>')">
