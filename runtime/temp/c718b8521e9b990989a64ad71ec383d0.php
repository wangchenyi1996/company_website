<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/company/public/../application/admin/view/newsinfo/news-list.html";i:1558325126;s:62:"/www/wwwroot/company/application/admin/view/common/header.html";i:1558333979;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="layui-side-scroll">
        <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
            ...
            <div style="margin-left:220px;">
                ...
                <div class="x-body">
                    <xblock><button class="layui-btn" onclick="window.location.href='<?php echo url('admin/newsinfo/add'); ?>'"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：<?php echo $count; ?> 条</span></xblock>
                    <table class="layui-table">
                        ...
                        <tbody id="x-img">
                            ...
                            <tr>
                                ...
                                <td class="newstime">
                                    <?php echo substr($vo['newstime'],0,10); ?>
                                </td>

                                <td  width="280">
                                    <?php echo $vo['newscontent']; ?>
                                    <!-- <a title="<?php echo $vo['newscontent']; ?>"> <?php echo mb_substr($vo['newscontent'],0,50) ?>...</a> -->
                                </td>
                                
                                <td>
                                        <?php if($vo['newsimg'] != ''): ?>
                                            <img src="http://www.aisanhui.com/static/<?php echo $vo['newsimg']; ?>" width="140" height="70">
                                        <?php else: ?>
                                            <span>暂无新闻图片</span>
                                        <?php endif; ?>
                                ...
                                <td width="500">
                                    <a href="<?php echo url('admin/newsinfo/newsdetail',array('id'=>$vo['id'])); ?>" title="<?php echo $vo['newsdetail']; ?>"> <?php echo mb_substr($vo['newsdetail'],0,100) ?>...</a>
                                </td>
                              
                                <td class="td-manage">
                                  
                                    <a title="编辑" href="<?php echo url('admin/newsinfo/edit',array('id'=>$vo['id'])); ?>" class="ml-5" style="text-decoration:none;margin-right: 20px;">
                                        <i class="layui-icon">&#xe642;</i>编辑
                                    </a>
                                    <a title="删除" onclick="admin_del('<?php echo url('admin/newsinfo/del',array('id'=>$vo['id'])); ?>')" style="text-decoration:none">
