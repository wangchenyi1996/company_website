<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/wwwroot/company/public/../application/admin/view/banner/banner-add.html";i:1558325124;s:62:"/www/wwwroot/company/application/admin/view/common/header.html";i:1558333979;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
            ...
            <div class="x-nav" style="margin-left: 220px;">
                    <span class="layui-breadcrumb">
                      ...
                      <a href="<?php echo url('admin/banner/add'); ?>">新增轮播图</a>
                    </span>
            ...
            <div class="x-body" style="margin-left:220px;background-color: #f6f6f6;height: 250px;width:30%;margin-top: 20px;border-radius: 15px;">
                <form class="layui-form" style="margin-top: 20px;" action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="layui-form-item" style="margin-bottom: 25px;">
                        ...
                        <div>      
                            <input type="file" name="pic" style="position: relative;top:10px;" required="" lay-verify="required"></input>
                        </div>
                    </div>
